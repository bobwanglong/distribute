...
func RegisterHandlers() {
	http.Handle("/", http.RedirectHandler("/students", http.StatusPermanentRedirect)) // 跳转?
...
func (studentsHandler) renderGrades(w http.ResponseWriter, r *http.Request, id int) {
	...
	if err != nil{
		log.Println("Failed to conver grade to JSON: ",g, err)
	}
	...
	if res.StatusCode != http.StatusCreated{
		log.Println("Failed to save grad to Grading Service .Status, ",res.StatusCode)
		return
	}
}
// package portal
